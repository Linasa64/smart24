...
function openTabELA(evt, glacierName) {
  ...
  function openSSP_mer(evt, sspName) {
    var i, tabcontent, tablinks;
    tabcontent = document.getElementsByClassName("tabcontent-ssp");
    console.log(tabcontent)
    for (i = 0; i < tabcontent.length; i++) {
      tabcontent[i].style.display = "none";
    }
    ...
    document.getElementById(sspName).style.display = "block";
    evt.currentTarget.className += " active";
    evt.preventDefault(); // Pour empêcher le comportement par défaut du lien
  }

  function openSSP_flux(evt, sspName) {
    var i, tabcontent, tablinks;
    tabcontent = document.getElementsByClassName("tabcontent-flux-ssp");
    console.log(tabcontent)
    for (i = 0; i < tabcontent.length; i++) {
      tabcontent[i].style.display = "none";
    }
